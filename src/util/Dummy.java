...
public class Dummy {
	...
	private void randomRental(List<BookManageVO> rentalList) {
		...
		rentalList.add(new BookManageVO("9788954670630", "history2", dm.toDate("20200207"), null));
		rentalList.add(new BookManageVO("9791160803235", "history2", dm.toDate("20200207"), null));
